...
IMG_DIR = '/home/haianyt/frustum-pointnets/sunrgbd/sunrgbd_data/matlab/SUNRGBDtoolbox/mysunrgbd/training/image'
...
dataset = sunrgbd_object('/home/haianyt/frustum-pointnets/sunrgbd/sunrgbd_data/matlab/SUNRGBDtoolbox/mysunrgbd', 'training')
VISU = FLAGS.viz
if VISU:
...
for img_id in shuffled_keys[0:1]:
    print("img_id = ",img_id)
    calib = dataset.get_calibration(img_id)
    ...
    debugResult = Image.fromarray(img)
    debugResult.save('./out.bmp')
